                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="text" placeholder="your token"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                v-model="token">
                        </div>
                        <button type="button" @click="login"
                            class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Connecter</button>
                        <div v-if="valid"
                        ...
                        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                            vous n'avez pas un compte ? <RouterLink to="/register"
                                class="text-blue-700 hover:underline dark:text-blue-500">Creer un compte</RouterLink>
                        </div>
                    </form>
                </div>
            </div>
